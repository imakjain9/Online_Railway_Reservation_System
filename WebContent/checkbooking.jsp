...
<body style="margin:0%; background-color:black; overflow-x:hidden;overflow-y:scroll">
...
<div class="row">
<div class="col-sm-2" style="height:616px;width:15%; background-color:green; z-index:100px; padding-top:30px;">
    <% if(s==null){%>
...
<div class="col-sm-10" style="padding:0px 10px; background-color:black; color:white; font-family: 'Comic Sans MS', cursive, sans-serif; font-size: 20px; height:616px; ">
    <h3><center> Check Reservations</center></h3>
    <div style="padding-left:250px;" class="form-group">
    <div style="color:white;text-align:right;font-size:18px;" class="control-label col-sm-4" >Enter Date:</div>
    <div class="col-sm-3">
    <input id="mySelect" type="date" class="form-control" name="selectedDate" required/>
    </div>
    <div class="col-sm-3">
    <button style="background:green; color:white;" onclick="callAjax()" class="btn btn-default">Submit</button>
    </div>
